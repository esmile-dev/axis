...
- **B-003** ~~pgvector 正向语义路径复验~~ **已复验**（2026-08-06，knowledge-chunking：`KnowledgeVectorSearchEval` 2/2 通过，含新增图文混排细节查询样例；智谱 embedding-3，修正 eval 缺 `dimensions=1536` 的 harness 问题后跑通）。
